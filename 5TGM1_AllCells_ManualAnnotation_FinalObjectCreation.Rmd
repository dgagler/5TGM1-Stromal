...
# Code used to manually annotate both the stromal and non-stromal compartment of the mouse BM. Requires the output of the QC/integration step.
...
# Save out
```{r}
saveRDS(stromals.subbed, "/Users/gagled01/morganLab/single-cell/5TG_Mouse_Rerun/objects/5TGM1_StromalsOnly_Annotated_21PCs_ContamRemoved_FinalObject.rds")
```
