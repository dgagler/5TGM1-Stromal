...
```
# Marker Genes of Main Stromal Populations - Supplementary Figure 4 Violin Plots
```{r}
Idents(stromals) <- "celltypes_ECsubbed"
# MSCs
...
#dev.off()
```
# Supplementary Figure 5 - Main Stromal Marker Gene Feature Plots
```{r}
# MSCs
...
#dev.off()
```
# Supplementary Figure XX - Senesecence 
```{r}
...
```{r}
p1.secrete <- VlnPlot(msclin, features = c("Cxcl12")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p2.secrete <- VlnPlot(msclin, features = c("Ppbp")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank(), plot.title = element_text(hjust = 0.5)) + labs(title = "Ppbp (Cxcl7)") + NoLegend()
p3.secrete <- VlnPlot(msclin, features = c("Pf4")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank(), plot.title = element_text(hjust = 0.5)) + labs(title = "Pf4 (Cxcl4)") + NoLegend()
p4.secrete <- VlnPlot(msclin, features = c("Tnfsf13b")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank(), plot.title = element_text(hjust = 0.5)) + labs(title = "Tnfsf13b (Baff)") + NoLegend()

p5.secrete <- VlnPlot(msclin, features = c("Bglap")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p6.secrete <- VlnPlot(msclin, features = c("Spp1")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank(), plot.title = element_text(hjust = 0.5)) + labs(title = "Spp1 (Opn)") + NoLegend()
p7.secrete <- VlnPlot(msclin, features = c("Col1a1")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p8.secrete <- VlnPlot(msclin, features = c("Alpl")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()

p9.secrete <- VlnPlot(msclin, features = c("Lpl")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p10.secrete <- VlnPlot(msclin, features = c("Adipoq")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p11.secrete <- VlnPlot(msclin, features = c("Mgp")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p12.secrete <- VlnPlot(msclin, features = c("Wif1")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()

p13.secrete <- VlnPlot(msclin, features = c("Fgf7")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p14.secrete <- VlnPlot(msclin, features = c("Igf1")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p15.secrete <- VlnPlot(msclin, features = c("Il7")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p16.secrete <- VlnPlot(msclin, features = c("Tnfsf11")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank(), plot.title = element_text(hjust = 0.5)) + labs(title = "Tnfsf11 (Rankl)") + NoLegend()

p17.secrete <- VlnPlot(msclin, features = c("Tgfb1")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p18.secrete <- VlnPlot(msclin, features = c("Tgfb3")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p19.secrete <- VlnPlot(msclin, features = c("Sp7")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
p20.secrete <- VlnPlot(msclin, features = c("Vegfa")) + theme(axis.title.x = element_blank(), axis.title.y = element_blank()) + NoLegend()
