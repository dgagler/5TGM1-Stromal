...
The goal of this code is to boot strap out stromal cell type abundances to generate p-values for our observed relative abundances, so we have a sense of how unlikely it is to see our observed relative abundances. This involves:

1. randomly subsampling (with replacement) from our total distribution of cell types (combined healthy + myeloma) a set number of times (will attempt trials at 10, 100, 1000, and 10000)
2. calculate specific statistic (in our case, wilcoxon paired t-test comparing our observed experimental relative abundances to our subsampled relative abundances)
...
Plotting
```{r}
bmec.c0.bxp <- ggboxplot(bmec.c0.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
bmec.c0.bxp <- bmec.c0.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
bmec.c1.bxp <- ggboxplot(bmec.c1.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
bmec.c1.bxp <- bmec.c1.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
bmec.c2.bxp <- ggboxplot(bmec.c2.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
bmec.c2.bxp <- bmec.c2.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
bmec.c3.bxp <- ggboxplot(bmec.c3.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
bmec.c3.bxp <- bmec.c3.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
bmec.c4.bxp <- ggboxplot(bmec.c4.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
bmec.c4.bxp <- bmec.c4.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
bmec.c5.bxp <- ggboxplot(bmec.c5.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
...
ggsave("/Users/gagled01/morganLab/single-cell/5TGM1_Stromal/figures/1000x_Bootstrap_BMEC_Cluster_Boxplots.png", height = 6, width = 8)
```
...
Plotting
```{r}
msclin.c0.bxp <- ggboxplot(msclin.c0.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("Relative Abundance") + xlab("") + ggtitle("Cluster 0") +
  theme_bw(base_size = 16) + 
  theme(axis.text.x = element_blank(),
         axis.ticks.x = element_blank(),
...
msclin.c0.bxp <- msclin.c0.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
msclin.c1.bxp <- ggboxplot(msclin.c1.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("") + xlab("") + ggtitle("Cluster 1") +
  theme_bw(base_size = 16) + 
  theme(
        axis.text.x = element_blank(),
...
msclin.c1.bxp <- msclin.c1.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
msclin.c2.bxp <- ggboxplot(msclin.c2.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("") + xlab("") + ggtitle("Cluster 2") +
  theme_bw(base_size = 16) +
theme(axis.text.x = element_blank(),
         axis.ticks.x = element_blank(),
...
msclin.c2.bxp <- msclin.c2.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
msclin.c3.bxp <- ggboxplot(msclin.c3.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("Relative Abundance") + xlab("") + ggtitle("Cluster 3") +
  theme_bw(base_size = 16) +
  theme(axis.text.x = element_blank(),
         axis.ticks.x = element_blank(),
...
msclin.c3.bxp <- msclin.c3.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
msclin.c4.bxp <- ggboxplot(msclin.c4.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("") + xlab("") + ggtitle("Cluster 4") +
  theme_bw(base_size = 16) +
  theme(legend.position = "bottom",
        axis.text.x = element_blank(),
...
msclin.c4.bxp <- msclin.c4.bxp + 
  ...
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.1)))
#############################################################
msclin.c5.bxp <- ggboxplot(msclin.c5.plotting.df, x = "Condition", y = "value", fill = "Condition", notch = TRUE) +
  ylab("") + xlab("") + ggtitle("Cluster 5") + 
  theme_bw(base_size = 16) + 
  theme(
        axis.text.x = element_blank(),
...
ggsave("/Users/gagled01/morganLab/single-cell/5TGM1_Stromal/figures/1000x_Bootstrap_msclin_Cluster_Boxplots.png", height = 7, width = 8)
```
